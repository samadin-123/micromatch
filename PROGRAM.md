...
Improve glob matching performance (ops/sec) as measured by the makeRe benchmark suite, focusing on pattern compilation speed for common glob patterns like stars, globstars, and braces.

## What you CAN modify

- `index.js` — main micromatch implementation
